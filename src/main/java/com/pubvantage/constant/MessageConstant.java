...
public class MessageConstant {
    ...
    public static String SKIP_LEARNING = "Skip learning";
    public static String SKIP_SCORING = "Skip scoring";
    public static String UPDATE_CHECKSUM_ERROR = "Update checksum fail. learning will be not started";
