...
public class CoreReportView {
    ...
    public CoreReportView(Long publisherId, Long masterReportViewId, String transforms, String weightedCalculations, String metrics, String dimensions, String name, String fieldTypes, String joinBy, Date created_Date, String sharedKeysConfig, String showInTotal, String formats, Long isShowDataSetName, Date lastActivity, Date lastRun, Long enableCustomDimensionMetric, Long subView, String filters, Long largeReport, Long availableToRun, Long availableToChange, String preCalculateTable) {
    ...
    public void setFieldTypes(String field_Types) {
    ...
    public void setJoinBy(String join_By) {
        this.joinBy = join_By;
    }
